...
class StoreResearchPaperRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'doi' => ['nullable', 'string', 'max:191', Rule::unique('research_papers', 'doi')->whereNotNull('doi')->whereNull('deleted_at')],
            'status' => ['nullable', Rule::in(['draft', 'published'])],
            'published_at' => ['nullable', 'date'],
            'slug' => ['nullable', 'string', 'alpha_dash', Rule::unique('research_papers', 'slug')->whereNull('deleted_at')],
